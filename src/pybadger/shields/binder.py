...
_SHIELDS_SETTINGS = _shields.ShieldsSettings(logo=_LOGO)
_TITLE = "Launch Jupyter notebook in Binder."
_MSG = "Try Online"
...
def github(
    ...
    ref : str
        The branch, tag, or commit hash to use.
    ...
    return _shields.core.static(
        message=_MSG,
        shields_settings=shields_settings + _SHIELDS_SETTINGS,
...
def gist(
    ...
    """Binder badge for a GitHub Gist.
...
def git(
    ...
    """Binder badge for a Git repository.
...
def gitlab(
    ...
    """Binder badge for a GitLab repository.
...
def zenodo(
    ...
    """Binder badge for a Zenodo repository.
...
def figshare(
    ...
    """Binder badge for a Figshare repository.
...
def hydroshare(
    ...
    """Binder badge for a HydroShare resource.
...
def dataverse(
    ...
    """Binder badge for a Dataverse repository.
